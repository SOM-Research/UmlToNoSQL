 ...
 * </p>
 * <ul>
 *   <li>{@link postgres.impl.DatabaseImpl#getTables <em>Tables</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DatabaseImpl extends NamedImpl implements Database {
	...
	protected EClass eStaticClass() {
		return PostgresPackage.Literals.DATABASE;
	}
	...
	public EList<Table> getTables() {
		if (tables == null) {
			tables = new EObjectResolvingEList<Table>(Table.class, this, PostgresPackage.DATABASE__TABLES);
		}
		return tables;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PostgresPackage.DATABASE__TABLES:
				return getTables();
		}
