...
/**
 * This is the item provider adapter for a {@link region.Region} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RegionItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addDrillDriverPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RegionPackage.Literals.REGION__NAME,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Drill Driver feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addDrillDriverPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Region_drillDriver_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Region_drillDriver_feature", "_UI_Region_type"),
				 RegionPackage.Literals.REGION__DRILL_DRIVER,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addClassesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Region_classes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Region_classes_feature", "_UI_Region_type"),
				 RegionPackage.Literals.REGION__CLASSES,
				 true,
				 false,
				 true,
				 null,
	...
	public ResourceLocator getResourceLocator() {
		return RegionEditPlugin.INSTANCE;
	}
