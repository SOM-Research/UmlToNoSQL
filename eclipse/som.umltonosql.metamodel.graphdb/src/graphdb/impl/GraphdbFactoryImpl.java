 ...
 * @generated
 */
public class GraphdbFactoryImpl extends EFactoryImpl implements GraphdbFactory {
	/**
	 ...
	 * @generated
	 */
	public static GraphdbFactory init() {
		try {
			GraphdbFactory theGraphdbFactory = (GraphdbFactory)EPackage.Registry.INSTANCE.getEFactory(GraphdbPackage.eNS_URI);
			if (theGraphdbFactory != null) {
				return theGraphdbFactory;
			}
		}
		catch (Exception exception) {
			EcorePlugin.INSTANCE.log(exception);
		}
		return new GraphdbFactoryImpl();
	}
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case GraphdbPackage.GRAPH: return createGraph();
	 ...
	 * @generated
	 */
	public GraphdbPackage getGraphdbPackage() {
		return (GraphdbPackage)getEPackage();
	}
	 ...
	 */
	@Deprecated
	public static GraphdbPackage getPackage() {
		return GraphdbPackage.eINSTANCE;
	}
