 ...
 * </p>
 * <ul>
 *   <li>{@link relationaldb.impl.ForeignKeyImpl#getReferencedColumn <em>Referenced Column</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ForeignKeyImpl extends ColumnImpl implements ForeignKey {
	...
	protected EClass eStaticClass() {
		return RelationaldbPackage.Literals.FOREIGN_KEY;
	}
		...
		if (referencedColumn != null && referencedColumn.eIsProxy()) {
			...
			if (referencedColumn != oldReferencedColumn) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RelationaldbPackage.FOREIGN_KEY__REFERENCED_COLUMN, oldReferencedColumn, referencedColumn));
			}
		}
	...
	public void setReferencedColumn(Column newReferencedColumn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RelationaldbPackage.FOREIGN_KEY__REFERENCED_COLUMN, oldReferencedColumn, referencedColumn));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RelationaldbPackage.FOREIGN_KEY__REFERENCED_COLUMN:
