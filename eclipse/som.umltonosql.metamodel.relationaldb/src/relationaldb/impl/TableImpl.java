 ...
 * </p>
 * <ul>
 *   <li>{@link relationaldb.impl.TableImpl#getCol <em>Col</em>}</li>
 *   <li>{@link relationaldb.impl.TableImpl#getPrimaryKeys <em>Primary Keys</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TableImpl extends NamedImpl implements Table {
	...
	public EList<Column> getCol() {
		if (col == null) {
			col = new EObjectContainmentWithInverseEList<Column>(Column.class, this, RelationaldbPackage.TABLE__COL, RelationaldbPackage.COLUMN__OWNER);
		}
		return col;
	}
	...
	public EList<Column> getPrimaryKeys() {
		if (primaryKeys == null) {
			primaryKeys = new EObjectResolvingEList<Column>(Column.class, this, RelationaldbPackage.TABLE__PRIMARY_KEYS);
		}
		return primaryKeys;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RelationaldbPackage.TABLE__COL:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RelationaldbPackage.TABLE__COL:
				return getCol();
			case RelationaldbPackage.TABLE__PRIMARY_KEYS:
