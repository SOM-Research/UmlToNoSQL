...
public class RelationaldbSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case RelationaldbPackage.NAMED: {
			...
			case RelationaldbPackage.FOREIGN_KEY: {
			...
			case RelationaldbPackage.TYPE: {
				Type type = (Type)theEObject;
				T result = caseType(type);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RelationaldbPackage.PRIMITIVE_TYPE: {
			...
			case RelationaldbPackage.VARCHAR: {
			...
			case RelationaldbPackage.INTEGER: {
				relationaldb.Integer integer = (relationaldb.Integer)theEObject;
			...
			case RelationaldbPackage.UML_TO_NO_SQLID: {
	 ...
	 * @generated
	 */
	public T caseInteger(relationaldb.Integer object) {
		return null;
	}
